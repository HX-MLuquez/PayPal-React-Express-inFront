# Challenge web - Integración de PayPal

### En este challenge web, el objetivo es integrar PayPal en una aplicación web.

Para este proyecto, se debe desarrollar una aplicación web que permita a los usuarios realizar pagos utilizando PayPal. 
...
¡Esperamos que este challenge resulte útil para desarrollar tus habilidades con Express y la integración de PayPal!!!
